...
export const DEFAULT_PLAN: GeniusPlan = {
  ...
  retrieve: { label: '主動回想', prompt: '不看答案，先自己回想意思與用法，再翻開對照。' },
