...
export default function TalentCardGameGuide() {
  ...
  return <main className="min-h-screen bg-[#f4efe5] pb-24 text-[#173a34]">
    ...
    <section className="mx-auto max-w-5xl px-4 py-10 md:py-16">
      ...
      <section className="mt-10 rounded-[32px] bg-[#f6dfd5] p-7 md:p-9"><Sparkles className="h-7 w-7 text-[#e26a3b]" /><h2 className="mt-3 text-3xl font-black">新手最簡單的玩法</h2><ol className="mt-5 space-y-3 text-[#355b54]"><li>1. 先讀中文任務。</li><li>2. 選有「天份加成」的卡。</li><li>3. 不知道怎麼說時，點「使用示範答案」。</li><li>4. 大聲讀一次，再按「送出回應」。</li><li>5. 看回饋後，把修正版再說一次。</li></ol><Button onClick={() => navigate('/talent-card-game')} className="mt-7 rounded-full bg-[#173a34] px-7">我懂了，開始遊戲 <ChevronRight className="ml-1 h-4 w-4" /></Button></section>
    </section>
  </main>;
}
